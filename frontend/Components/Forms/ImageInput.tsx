...
const ImageInput = ({labelId,
  ...
  return (
    <div>
        <label
            htmlFor={labelId}
            className="flex w-[300px] min-h-[200px] overflow-hidden relative justify-center gap-2 items-center hover:bg-primary hover:text-gray-700 bg-white border border-primary rounded-md text-primary cursor-pointer"
        >
            <span
                className="h-full"
            >
